...
function Detail() {
  ...
  return (
    <Fragment>
      <BackgroundImage url='https://cdn.jsdelivr.net/gh/Qiu-Weidong/blog/resources/images/%E5%A3%81%E7%BA%B8/wallhaven-47z5vy.jpg' />
      {/* <AppBar sx={{ 'background-color': 'rgba(255,255,255,0.9)' }}>
        <Toolbar> */}
          <Search />
        {/* </Toolbar>
      </AppBar>
